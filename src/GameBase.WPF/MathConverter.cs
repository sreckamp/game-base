...
//    public class MathConverter : AbstractMathExtension, IValueConverter
//    {
...
//            mathEquation = mathEquation.ToUpper().Replace("@VALUE", value.ToString());

//            try
//            {
//                var retVal = Evaluate(mathEquation);
//                return retVal;
//            }
//            catch (Exception)
//            {
//                Debug.WriteLine("Cannot evaluate " + mathEquation);
...
//    // Use @VALUE in your mathEquation as a substitute for bound value
//    // Operator order is parenthesis first, then Left-To-Right (no operator precedence)
//    public class MultiMathConverter : AbstractMathExtension, IMultiValueConverter
//    {
//        public override object ProvideValue(IServiceProvider serviceProvider)
//        {
//            return this;
...
//            {
//                mathEquation = mathEquation.ToUpper().Replace("@VALUE" + i, value[i].ToString());
//            }
...
//    // Use @VALUE in your mathEquation as a substitute for bound value
//    // Operator order is parenthesis first, then Left-To-Right (no operator precedence)
//    public abstract class AbstractMathExtension : MarkupExtension
//    {
...
//        protected double Evaluate(string mathEquation)
//        {
